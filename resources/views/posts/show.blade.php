                    ...
                    <div class="card">
                        <div class="card-body mt-4">
                            ...
                            <div class="d-flex justify-content-between ">
                                ...
                                @auth
                                    <div class="d-flex justify-content-between ">
                                        <form id="add-like-form" action="{{ route('comment.like', $comments->id) }}" method="GET">
                                ...
                                @endauth
                                @guest
                                    <p class="text text-success"><a href="{{ route('login') }}"
                                            style="text-decoration: none"> login </a> or <a href="{{ route('register') }}"
